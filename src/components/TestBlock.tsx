...
export const TestBlock: React.FC = () => {
  ...
  const describePropBoolean = useSelector(
    (state: any) => state.describePropBoolean
  );
    ...
    <div className="testBlock">
      ...
      <div className="headerbar">
        <ul className="headerlist">
          ...
          <li>
            <button className="generatetests" onClick={handleClick}>
              Generate Tests
            </button>
          </li>
          <li>
        ...
        <ul className="iconlist">
          <li>
            <a
              href="https://github.com/oslabs-beta/Catalyst"
              target="_blank"
              rel="noreferrer"
            >
